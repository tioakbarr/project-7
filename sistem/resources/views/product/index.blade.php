      ...
      <div class="card-body">
        <form action="{{url('product/filter')}}" method="post">
          ...
          <div class="form-group">
            <label style="display: block;" class="control-label">Nama</label>
            <input style="display: block; width: 100%;" type="text" class="form-control" name="nama" value='{{$nama ?? ""}}'>
        ...
        <div class="col-md-12">
          @include('utils.notif')
	    			...
	    			<div class="card">
	    				<div class="card-header">
	    					DATA PRODUK
	    					<a href="{{url('product\create')}}"><btn class="btn btn-dark float-right"><i class="fa fa-plus"></i> Tambah Data</btn></a>
	    					<div class="card-body">
